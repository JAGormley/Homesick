...
ds_map_add(statesToSprites, states.runJumping, spJumping)
...
ds_map_add(statesToSprites, states.landing, spLanding)
...
ds_map_add(statesToScripts, states.runJumping, scRunJumping)
...
ds_map_add(statesToScripts, states.landing, scLanding)
...
ds_map_add(statesToSpriteAnimSpeeds, states.runJumping, 12)
...
ds_map_add(statesToSpriteAnimSpeeds, states.landing, 15)
